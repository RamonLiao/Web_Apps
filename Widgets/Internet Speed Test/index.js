...
// Get random image from upsplash.com
...
image.onload = async function () {
  ...
  await fetch(imageApi).then((res) => {
    imageSize = res.headers.get("content-length"); // in Bytes
    calculateSpeed();
  });
};
...
function calculateSpeed() {
  ...
  // If all tests completed (we get 5 images then calculate mean value)
