...
const csvResponse = document.getElementById("csvResponseId");

createBtn.addEventListener("click", () => {
  alert("Creating a random CSV file...");
  ...
  xmlhttp.onreadystatechange = function () {
    if (xmlhttp.readyState == 4 && xmlhttp.status == 200) {
      // csvResponse.innerText = xmlhttp.responseText;
      console.log(xmlhttp.responseText);
    }
  };

  let endpoint = "/write-csv";
  let params = {
    columns: 29999,
    rows: 500,
    header: true,
